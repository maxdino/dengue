        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <h4 class="page-title">REGISTRAR NUEVA MICRORED  </h4>
              <ol class="breadcrumb">
                <li>
          ...
          <div class="row">
            <div class="col-sm-12">    
              <div class="card-box">
                <div class="row">
                  <div class="col-md-6">                   
                    <form action="<?php echo base_url();?>Microred_c/agregar" method="post" data-parsley-validate novalidate>

                      <div class="form-group">
                        <label for="microred">Microred*</label>
                        <input type="text" name="microred" parsley-trigger="change" required placeholder="Introduzca el nombre de la Microred" class="form-control" id="microred">
                      </div>
                      <div class="form-group">
