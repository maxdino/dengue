        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <h4 class="page-title">BIENVENIDOS AL REGISTRO DE RED <button id="agregar" class="btn btn-icon waves-effect waves-light btn-primary"> <i class="fa fa-plus"></i> </button></h4>
              <ol class="breadcrumb">
                <li>
                ...
                <tbody>
                  <?php  foreach($red as $value){ ?>
                    <tr id="<?php echo $value->id_red; ?>">
                      ...
                      <td ><a class="btn btn-icon waves-effect waves-light btn-primary" href="<?php echo base_url().'Red_c/editar/'.$value->id_red;?>" ><i class="fa fa-pencil"></i></a> <button class="btn btn-icon waves-effect waves-light btn-danger" onclick="mostrar_eliminar(<?php echo $value->id_red; ?>)"  data-toggle="modal" data-target="#eliminar_modal" > <i class="fa fa-trash"></i> </button></td>
                    </tr>
                    <?php  } ?>
                  </tbody>
                </table>
          ...
          <div class="modal-dialog panel panel-border panel-danger">
            <div class="modal-content panel-heading">
              ...
              <div class="modal-body"  >
                ...
                <p style="color:#787a79; font-size: 14px;">¿Estas seguro que desea eliminar esta Red?</p>
