        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <h4 class="page-title">REGISTRAR NUEVO MODULO  </h4>
              <ol class="breadcrumb">
                <li>
          ...
          <div class="row">
            <div class="col-sm-12">    
              <div class="card-box">
                <div class="row">
                  <div class="col-md-6">                   
                    <form action="<?php echo base_url();?>Modulo_c/agregar" method="post" data-parsley-validate novalidate>

                      <div class="form-group">
                        <label for="microred">Modulo*</label>
                        <input type="text" name="modulo" parsley-trigger="change" required placeholder="Introduzca el nombre del Modulo" class="form-control" id="modulo">
                      </div>
                      <div class="form-group">
                        ...
                        <input type="text" name="url" placeholder="Introduzca el url del Modulo" disabled="disabled" class="form-control" id="url">
                      </div>                    
