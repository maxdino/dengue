        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <h4 class="page-title">REGISTRAR NUEVO PERFIL DE USUARIO</h4>
              <ol class="breadcrumb">
                <li>
                ...
                <li>
                  <a href="<?php echo base_url();?>Perfil_usuario_c">Perfil de Usuario</a>
                </li>
                <li>
                ...
                <div class="card-box">
                  ...
                  <form action="<?php echo base_url();?>Perfil_usuario_c/agregar" method="post" data-parsley-validate novalidate>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="perfil_usuario" parsley-trigger="change" required placeholder="Introduzca el nombre del Perfil de Usuario" class="form-control" id="perfil_usuario">
                    </div>
