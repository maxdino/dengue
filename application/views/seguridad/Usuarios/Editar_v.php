                    ...
                    <div class="col-md-6">                   
                      <form action="" method="post" data-parsley-validate novalidate>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="nombres" parsley-trigger="change" required placeholder="Escribe sus nombres" class="form-control" id="nombres" value="<?php echo $value->nombre; ?>">
                          <input type="hidden" value="<?php echo $value->id_usuario; ?>" id="id_usuario_modificar">
                        </div>
                        <div class="form-group">
                          <label for="apellidos">Apellidos*</label>
                          <input type="text" name="apellidos" parsley-trigger="change" required placeholder="Escribe sus Apellidos" class="form-control" id="apellidos" value="<?php echo $value->apellido; ?>">
                        </div>
                        <div class="form-group">
                          <label for="usuario">Usuario*</label>
                          <input type="text" name="usuario" parsley-trigger="change" required placeholder="Escribe el nombre usuario" class="form-control" id="usuario" value="<?php echo $value->usuario; ?>" >
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" name="clave" parsley-trigger="change" required placeholder="Escribe su contraseña" class="form-control" id="clave" onkeyup="limpiar()" value="<?php echo base64_decode($usuario); ?>" >
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" name="clave_con" parsley-trigger="change" required placeholder="Escribe su contraseña para confirmar" class="form-control" id="clave_con" onkeyup="limpiar()"  value="<?php echo base64_decode($usuario); ?>" >
...
<script>
  $("form").on("submit", function(event) {
    ...
    if (clave==clave_con) {
      ...
      $.ajax({
        url: "<?php echo base_url();?>Usuarios_c/modificar",
        data: {nombres : nombres ,apellidos : apellidos ,nombres : nombres ,usuario : usuario, clave : clave, id_usuario:id_usuario},
        type : 'POST',
