        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <h4 class="page-title">BIENVENIDOS AL REGISTRO DE TIPOS <button id="agregar" class="btn btn-icon waves-effect waves-light btn-primary"> <i class="fa fa-plus"></i> </button></h4>
              <ol class="breadcrumb">
                <li>
            ...
            <div class="col-sm-12">
              <div class="card-box table-responsive">
                ...
                <tr id="<?php echo $value->id_tipos; ?>">
                  ...
                  <td ><a class="btn btn-icon waves-effect waves-light btn-primary" href="<?php echo base_url().'Tipos_c/editar/'.$value->id_tipos;?>" ><i class="fa fa-pencil"></i></a> <button class="btn btn-icon waves-effect waves-light btn-danger" onclick="mostrar_eliminar(<?php echo $value->id_tipos; ?>)"  data-toggle="modal" data-target="#eliminar_modal" > <i class="fa fa-trash"></i> </button></td>
                </tr>
                <?php  } ?>
                </tbody>
              </table>
          ...
          <div class="modal-dialog panel panel-border panel-danger">
            <div class="modal-content panel-heading">
              ...
              <div class="modal-body"  >
                ...
                <p style="color:#787a79; font-size: 14px;">¿Estas seguro que desea eliminar esta Tipos?</p>
...
function mostrar_eliminar(id) {
 ...
 $( "#eliminar" ).click(function() {
      ...
      t.fnDeleteRow(nRow); 
      $.ajax({
        url : "<?php echo base_url();?>Tipos_c/eliminar",
        data : {id : id},
        type : 'POST',
