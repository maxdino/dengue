        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <h4 class="page-title">MODIFICAR CATEGORIA  </h4>
              <ol class="breadcrumb">
                <li>
          ...
          <div class="row">
                ...
                <div class="card-box">
                    <div class="row">
                    <div class="col-md-6">                   
                  <form action="<?php echo base_url();?>Categorias_c/modificar" method="post" data-parsley-validate novalidate>
                   
                    <div class="form-group">
                      <label for="categorias">Categorias*</label>
                      <input type="text" name="categorias" parsley-trigger="change"  value="<?php echo $value->categorias; ?>" required placeholder="Introduzca el nombre del tipo" class="form-control" id="categorias" >
                      <input type="hidden" value="<?php echo $value->id_categorias; ?>" name="id_categorias" id="id_categorias">
                    </div>
